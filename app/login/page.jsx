    ...
    if (session) {
        ...
        return (
            <div className="text-white ">
                <div className="absolute inset-0 -z-10 h-full w-full items-center px-5 py-24 [background:radial-gradient(125%_125%_at_50%_10%,#000_40%,#63e_100%)]"></div>
                <div className="text-white font-bold text-2xl text-center py-10">Login/Signup to get your fans to support you</div>
                <div className="SOCIAL_LOGIN_BTN flex flex-col justify-center items-center">
      ...
      bg-white dark:bg-gray-800 border-2 border-red-100 dark:border-red-900/30 text-gray-800 dark:text-gray-100 hover:bg-red-50 dark:hover:bg-gray-700 group"
                        >
                            <svg
